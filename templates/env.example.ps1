...
# $env:SANDBOX_ADMISSION_SMALL_PHYSICAL_WEIGHT = "0.25"
# $env:SANDBOX_ADMISSION_PRESSURE_MAX_AGE_MS = "2000"
...
# $env:SANDBOX_PROCESS_TREE_MAX_MEMORY_MB = "4096"

# Optional reservations for tools whose child-process lifetime is managed as one unit.
# $env:SANDBOX_CODEX_MEMORY_REQUEST_MB = "384"
# $env:SANDBOX_CODEX_MAX_MEMORY_MB = "1536"
