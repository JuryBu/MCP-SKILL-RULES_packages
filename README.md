...
| 组件 | 版本 | 主要用途 |
| --- | ---: | --- |
| `memory-store` | 1.21.1 | 记忆、Conversation、Record、Golden Extract、Stage Guard、调度恢复与跨宿主路由 |
...
| --- | ---: | --- |
| `memory-store` | 1.21.1 | Memory, Conversation, Record, Golden Extract, Stage Guard, scheduling recovery, and host routing |
