...
| `sandbox` | 1.16.1 | 隔离执行、全局内存调度、按需 artifact、自适应输出、持久会话、Codex 任务与多模型 Council |
...
| `sandbox` | 1.16.1 | Isolated execution, global memory admission, on-demand artifacts, adaptive output, sessions, Codex tasks, and multi-model Council |
