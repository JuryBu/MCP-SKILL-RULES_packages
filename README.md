...
| MCP | 当前版本 | 主要能力 |
| --- | --- | --- |
| `memory-store` | `1.15.4` | 记忆库、对话读取、Conversation Export、Record、Conversation、Golden Extract、Stage Guard、四源数据链路 |
...
| --- | --- | --- |
| `memory-store` | `1.15.4` | Memory, conversation reading, Conversation Export, Records, Conversation, Golden Extract, Stage Guard, four-source data chains |
