...
export function registerInteract(server) {
        ...
        try {
            ...
            if (sessionId) {
                ...
                if (!page) {
                    return {
                        isError: true,
                        content: [{ type: "text", text: `会话 "${sessionId}" 不存在或已过期` }],
                    };
                }
            }
            else if (params.url) {
                ...
                return {
                    isError: true,
                    content: [{ type: "text", text: "必须提供 sessionId 或 url" }],
                };
            }
            ...
            switch (params.action) {
                case "click": {
                    if (!params.selector) {
                        return {
                            isError: true,
                            content: [{ type: "text", text: "click 操作需要提供 selector" }],
                        };
                    }
                ...
                case "type": {
                    if (!params.selector || !params.value) {
                        return {
                            isError: true,
                            content: [{ type: "text", text: "type 操作需要提供 selector 和 value" }],
                        };
                    }
                    await page.waitForSelector(params.selector, { timeout });
                ...
                case "scroll": {
                    if (params.selector) {
                        ...
                        if (!el) {
                            return {
                                isError: true,
                                content: [{ type: "text", text: `scroll 操作未找到选择器 "${params.selector}"` }],
                            };
                        }
                ...
                case "wait": {
                    if (!params.selector) {
                        return {
                            isError: true,
                            content: [{ type: "text", text: "wait 操作需要提供 selector" }],
                        };
                    }
                    await page.waitForSelector(params.selector, { timeout });
                    return appendTiming({
                ...
                case "content": {
                    ...
                    if (params.selector) {
                        ...
                        if (elements.length === 0) {
                            return {
                                isError: true,
                                content: [{ type: "text", text: `content 操作未找到选择器 "${params.selector}" 匹配的元素` }],
                            };
                        }
                        const parts = [];
                ...
                case "find": {
                    if (!params.value) {
                        return {
                            isError: true,
                            content: [{ type: "text", text: "find 操作需要 value 参数（搜索关键词）" }],
                        };
                    }
                ...
                default:
                    return {
                        isError: true,
                        content: [{ type: "text", text: `不支持的操作: ${params.action}` }],
                    };
            }
        }
        catch (error) {
            ...
            return {
                isError: true,
                content: [{ type: "text", text: `交互操作失败: ${message}` }],
            };
        }
    });
}
