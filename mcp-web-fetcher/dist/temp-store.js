 ...
 * @returns 文件绝对路径
 */
export function saveTempFile(category, key, ext, data) {
    ensureTempDirs();
 ...
 */
export function getTempFile(category, key, ext) {
 ...
 */
export function fileHashKey(filePath) {
    try {
        const stat = fs.statSync(filePath);
 ...
 * @returns SplitResult
 */
export async function splitOversizedImage(buffer, category, baseKey, ext = ".jpg") {
    let sharp;
    try {
...
//# sourceMappingURL=temp-store.js.map