...
import { extractContent, compactContent, truncateContent, cleanFooterGarbage, detectSPAIssue, detectEncodingIssue, type OutputMode } from "../extractor.js";
import { touchActivity } from "../lifecycle.js";
import {
    QUALITY_PRESETS, SCREENSHOT_MIME_TYPE,
    type ImageQuality, type SaveMode,
    appendTiming,
    AI_SUMMARY_MAX_INPUT, AI_SUMMARY_PROMPT_TEMPLATE,
} from "../constants.js";
