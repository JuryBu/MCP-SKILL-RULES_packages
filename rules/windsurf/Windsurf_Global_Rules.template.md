...
生日8.12，AI专业大三，兴趣ACGN（剧情爱好者）+音乐。
网易云 <接收方自行填写的公开账号链接> ｜B站 <接收方自行填写的公开账号链接>
知乎/抖音/X/Reddit 在 MCP web-fetcher 已登录。聊天可搜实时话题别强找。
...
网页截图/文本/交互/表格/链接提取、file://查看Office/PDF/图片/视频、格式转换(web_convert)、桌面应用调试(desktop_*)。翻墙代理访问Google/X/Reddit等。知乎/B站/微博/小红书/网易云/Reddit/X/Gmail 已登录。
