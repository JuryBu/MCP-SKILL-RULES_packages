...
需要主人采取操作、作出决定，或发生长任务完成/失败、安全暂停、人工登录、双机通信中断等值得离开 Codex 后及时知晓的事件时，先登记当前对话的 owner route，再向 binding 预配置的私聊或通知群发送简短人话；普通心跳、例行进度、内部诊断和可自动恢复的短暂异常不发送。通知只说明发生了什么、是否需要主人行动，不倾倒训练日志、字段块或内部 `route_key`。主人在私聊引用该通知回复，或在群聊引用并 @ 本机账号，系统才把回复精确送回当前对话。
