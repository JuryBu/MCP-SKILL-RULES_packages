...
if "%~1"=="" (
  echo Codex app tools compatibility launcher could not start: missing launcher path. 1>&2
  exit /b 64
)
...
echo Codex app tools compatibility launcher could not find a Node runtime. Reinstall or update Codex. 1>&2
exit /b 127
