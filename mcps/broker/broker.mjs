  ...
  ...(napcatEnabled ? {
    napcat: {
      ...
      env: {
        ...
        NAPCAT_TASK_REGISTRY_PATH: process.env.NAPCAT_TASK_REGISTRY_PATH || path.join(toolkitDataRoot, "napcat-mcp", "state", "task-registry.json"),
        NAPCAT_TASK_ROUTER_RUNTIME_PATH: process.env.NAPCAT_TASK_ROUTER_RUNTIME_PATH || path.join(toolkitDataRoot, "napcat-mcp", "state", "task-router-runtime.json"),
        NAPCAT_TASK_ROUTER_LOG_PATH: process.env.NAPCAT_TASK_ROUTER_LOG_PATH || path.join(toolkitDataRoot, "napcat-mcp", "state", "task-router.jsonl"),
        NAPCAT_TASK_ROUTER_STOP_PATH: process.env.NAPCAT_TASK_ROUTER_STOP_PATH || path.join(toolkitDataRoot, "napcat-mcp", "state", "task-router.stop"),
        NAPCAT_TASK_ROUTER_LOCK_PATH: process.env.NAPCAT_TASK_ROUTER_LOCK_PATH || path.join(toolkitDataRoot, "napcat-mcp", "state", "task-router.lock"),
        CODEX_TOOLKIT_NAPCAT_DATA_ROOT: process.env.CODEX_TOOLKIT_NAPCAT_DATA_ROOT || path.join(toolkitDataRoot, "napcat-mcp"),
        CODEX_TOOLKIT_BROKER_ROOT: process.env.CODEX_TOOLKIT_BROKER_ROOT || brokerRoot,
      },
    },
  } : {}),
  subagent: {
