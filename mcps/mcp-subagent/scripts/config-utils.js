...
export const dataDir = process.env.SUBAGENT_DATA_DIR || path.join(os.homedir(), ".codex-toolkit", "mcp-subagent");
...
export const defaults = {
  ...
  brokerConfig: process.env.WSF_BROKER_CONFIG || path.join(userHome, ".gemini", "antigravity", "mcp_config.json"),
  windsurfConfig: process.env.WSF_CONFIG || path.join(userHome, ".codeium", "windsurf", "mcp_config.json"),
};
