...
| Area | Contents |
| --- | --- |
| MCP | memory-store 1.22.4, web-fetcher 7.0.0, sandbox 1.16.2, broker 0.1.0 |
...
- Common MCP versions are memory-store 1.22.4, web-fetcher 7.0.0, sandbox 1.16.2, broker 0.1.0, and Windsurf-only mcp-subagent 1.1.0.
...
- sandbox 1.16.2 retains backend-wide memory admission and adaptive 100K-token/2000-line/1MiB delivery, fixes caller character/line budget accounting and structured-result visibility, and bounds aggregate batch responses. Six-hour output artifacts remain limited to overflow, explicit file/manifest delivery, interrupted recovery, or spool cleanup failure.
