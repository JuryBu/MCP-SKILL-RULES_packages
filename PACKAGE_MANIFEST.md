...
| Area | Contents |
| --- | --- |
| MCP | memory-store 1.22.4, web-fetcher 7.0.0, sandbox 1.16.0, broker 0.1.0 |
...
- Common MCP versions are memory-store 1.22.4, web-fetcher 7.0.0, sandbox 1.16.0, broker 0.1.0, and Windsurf-only mcp-subagent 1.1.0.
