...
import { findMemoryById, deleteMemoryFile, readWorkspaceIndex, writeWorkspaceIndex, syncGlobalIndexForWorkspace, } from "../store.js";
/**
 * memory_delete — 删除记忆
 */
export function registerDelete(server) {
    server.tool("memory_delete", "删除一条记忆。", {
